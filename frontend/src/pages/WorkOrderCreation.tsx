...
import InsuranceInfo from '../components/work-order/InsuranceInfo';
  ...
  useEffect(() => {
    if (workOrderData && companiesData && documentTypes && documentTypes.length > 0 && !workOrderLoading) {
      ...
      const formValues = {
        ...
        insurance_claim_number: workOrderData.insurance_claim_number || '',
        insurance_policy_number: workOrderData.insurance_policy_number || '',
        insurance_company: workOrderData.insurance_company || '',
        insurance_deductible: workOrderData.insurance_deductible || '',
        insurance_adjuster_name: workOrderData.insurance_adjuster_name || '',
        insurance_adjuster_email: workOrderData.insurance_adjuster_email || '',
        insurance_adjuster_phone: workOrderData.insurance_adjuster_phone || '',
        insurance_date_of_loss: workOrderData.insurance_date_of_loss || undefined,
  ...
  const handleSave = async (status: 'draft' | 'pending' = 'draft') => {
    try {
      ...
      const workOrderFormData: any = {
        ...
        insurance_adjuster_name: values.insurance_adjuster_name,
        insurance_adjuster_email: values.insurance_adjuster_email,
        insurance_adjuster_phone: values.insurance_adjuster_phone,
        insurance_date_of_loss: values.insurance_date_of_loss,
