    ...
    tables: [
      // Install items
      {
        ...
        data: [
          ...
          { key: 'tr7', grade: 'Other', item_name: 'Crown molding', item: '`FNC CM` Crown molding', unit: 'LF', price: '—', note: '' },
          { key: 'tr8', grade: '', item_name: 'Casing', item: '`FNC C` Casing', unit: 'LF', price: '—', note: '' },
          { key: 'tr9', grade: '', item_name: 'Reducer strip', item: '`FCW LAMR` Reducer strip', unit: 'LF', price: '$7.90', note: '방 전환부' },
        ],
      },
      // Finish (paint / stain) items
      {
        ...
        data: [
          ...
          { key: 'tf5', grade: 'Stain', item_name: 'Stain & finish baseboard', item: '`PNT BS`', unit: 'LF', price: '$1.79', note: '원목 baseboard — oil stain+poly+putty' },
          { key: 'tf6', grade: '', item_name: 'Stain & finish base shoe/QR', item: '`PNT` stain+finish base shoe/QR', unit: 'LF', price: '—', note: '원목 QR/shoe — oil stain+poly+putty' },
          { key: 'tf7', grade: '', item_name: 'Seal & paint crown molding - 2 coats', item: '`PNT CWN2`', unit: 'LF', price: '$1.72', note: '' },
        ],
      },
    ],
  },
