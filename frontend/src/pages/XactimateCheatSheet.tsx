...
const sections: Section[] = [
  ...
  // ─── LVP ───
  {
    ...
    tables: [{
      ...
      data: [
        ...
        { key: 'l5b', type: '', item: '`FCW BARR` Vapor barrier - 15# felt', unit: 'SF', price: '$0.29', note: 'Nail-down hardwood 필수', desc: 'A 15-lb roofing felt vapor barrier is required under nail-down hardwood flooring. It prevents moisture migration from the subfloor and eliminates wood-on-wood friction that causes squeaking. Includes felt material and installation labor.' },
        ...
        { key: 'l11b', type: '', item: '`FCW LAMT` T-molding', unit: 'LF', price: '—', note: '같은 높이 바닥 전환부', desc: 'T-molding is used at doorway transitions where two floors of equal height meet. Reducer strips handle height differences; T-molding covers the expansion gap between same-height floating floors. Both may be needed in the same project if room transitions vary.' },
  ...
  // ─── HARDWOOD ───
  {
    ...
    tables: [{
      ...
      data: [
        ...
        { key: 'w12', mode: '계단', item: '`FCW FINSTP` Sand, stain & finish steps/risers', unit: 'LF', price: '$16.18', note: 'tread+riser 각각 LF 계산', desc: 'Price is per LF of tread and/or risers. Tread and risers are counted separately — e.g., a 3\' wide stairway with 12 treads and 12 risers = 3 LF × 24 = 72 LF. Cost includes sanding, filling, staining, and finishing labor and materials.' },
        { key: 'w13', mode: '', item: '`FCW FINSTP` Sand & finish steps (natural)', unit: 'LF', price: '—', note: 'stain 없이 natural finish', desc: 'Sand & finish steps and/or risers with natural (clear) finish — no stain applied. Price is per LF of tread and/or risers counted separately. E.g., 3\' wide stairway = 3 LF × number of treads/risers.' },
        { key: 'w14', mode: '', item: '`FCW FINSTP` Sand, stain & finish (uniform match)', unit: 'LF', price: '$16.18', note: '[miss]바닥 교체 시 계단 refinish', desc: 'To ensure a Reasonable Uniform Appearance, the stairs must be sanded and refinished to match the new flooring\'s color and sheen, as they share a continuous line of sight. This process is essential to restore the home to its pre-loss condition and prevent a significant mismatch that would diminish the property\'s aesthetic and market value. Price is per LF — tread and risers counted separately (e.g., 3\' wide × 24 treads+risers = 72 LF).' },
      ],
    }],
  },
  ...
  // ─── TRIM ───
  {
    ...
    rules: [
      ...
      {
        type: 'warning', title: 'Demo로 Door/Window Trim 파손 시',
        items: [
      ...
      {
        type: 'purple', title: 'Paint Grade vs Stain Grade 판단',
        items: [
    ...
    tables: [
      ...
      // Finish (paint / stain) items
      {
        columns: [
          ...
          { title: 'Unit', dataIndex: 'unit', key: 'unit', render: unitRender },
          { title: '가격', dataIndex: 'price', key: 'price', render: priceRender },
          { title: '포함 내역', dataIndex: 'note', key: 'note', render: missRender },
        ],
        data: [
