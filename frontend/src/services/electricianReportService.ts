...
export const DEFAULT_INSPECTION_CHECKLIST: ChecklistSection[] = [
  ...
  },
  {
    ...
    items: [
      { label: 'Junction boxes — condition / accessibility', status: 'N/A' },
      { label: 'Wire connectors (wire nuts) — condition', status: 'N/A' },
      { label: 'Wire insulation — condition', status: 'N/A' },
      { label: 'NM cable (Romex) — condition', status: 'N/A' },
      { label: 'Conduit / raceway — condition', status: 'N/A' },
      { label: 'Outlet / switch boxes — condition', status: 'N/A' },
    ],
  },
  {
