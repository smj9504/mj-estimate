...
def upgrade() -> None:
    ...
    # Helper function to safely drop column
    ...
    def safe_drop_constraint(constraint_name, table_name, type_):
        result = conn.execute(sa.text(
    ...
    op.alter_column('estimates', 'tax_method',
               ...
               existing_nullable=True)
    safe_drop_index('idx_estimates_client_city', 'estimates')
    safe_drop_index('idx_estimates_client_state', 'estimates')
    safe_drop_index('idx_estimates_client_zipcode', 'estimates')
    safe_drop_index('idx_estimates_estimate_type', 'estimates')
    safe_drop_index('idx_estimates_loss_date', 'estimates')
    ...
    op.alter_column('invoice_items', 'sort_order',
               ...
               existing_nullable=True)
    safe_drop_index('ix_invoice_items_primary_group', 'invoice_items')
    safe_drop_index('ix_invoice_items_sort_order', 'invoice_items')
    ...
    op.alter_column('invoices', 'has_receipt',
               ...
               server_default=None,
               existing_nullable=True)
    safe_drop_index('idx_invoices_client_company_id', 'invoices')
    safe_drop_index('idx_invoices_has_receipt', 'invoices')
    ...
    op.alter_column('line_item_note_mappings', 'order_index',
               ...
               server_default=None,
               existing_nullable=True)
    safe_drop_index('idx_line_item_note_mappings_line_item', 'line_item_note_mappings')
    safe_drop_index('idx_line_item_note_mappings_note', 'line_item_note_mappings')
    safe_drop_constraint('line_item_note_mappings_line_item_id_note_id_key', 'line_item_note_mappings', 'unique')
    ...
    op.alter_column('line_item_notes', 'updated_at',
               ...
               server_default=None,
               existing_nullable=True)
    safe_drop_index('idx_line_item_notes_category', 'line_item_notes', postgresql_where='(category IS NOT NULL)')
    safe_drop_index('idx_line_item_notes_company_id', 'line_item_notes', postgresql_where='(company_id IS NOT NULL)')
    ...
    op.alter_column('line_item_templates', 'updated_at',
               ...
               server_default=None,
               existing_nullable=True)
    safe_drop_index('idx_line_item_templates_category', 'line_item_templates', postgresql_where='(category IS NOT NULL)')
    safe_drop_index('idx_line_item_templates_company_id', 'line_item_templates', postgresql_where='(company_id IS NOT NULL)')
    safe_drop_index('idx_line_item_templates_is_active', 'line_item_templates')
    ...
    op.alter_column('line_items', 'updated_at',
               ...
               server_default=None,
               existing_nullable=True)
    safe_drop_index('idx_line_items_company_id', 'line_items', postgresql_where='(company_id IS NOT NULL)')
    safe_drop_index('idx_line_items_description_trgm', 'line_items', postgresql_using='gin')
    ...
    safe_drop_constraint('fk_line_item_category', 'line_items', 'foreignkey')
    op.create_foreign_key(None, 'line_items', 'companies', ['company_id'], ['id'])
    # Drop GIN index before altering JSONB column type
    safe_drop_index('idx_template_line_items_embedded_item_code', 'template_line_items', postgresql_using='gin')
    safe_drop_index('idx_template_line_items_line_item', 'template_line_items')
    safe_drop_index('idx_template_line_items_template', 'template_line_items')
    ...
    op.alter_column('water_mitigation_jobs', 'property_zipcode',
               ...
               existing_nullable=True)
    safe_drop_index('ix_wm_jobs_property_state', 'water_mitigation_jobs')
    safe_drop_index('ix_wm_jobs_property_street', 'water_mitigation_jobs')
    safe_drop_index('ix_wm_jobs_property_zipcode', 'water_mitigation_jobs')
    safe_drop_index('ix_wm_documents_active', 'wm_documents')
    ...
    op.alter_column('wm_photos', 'is_trashed',
               ...
               server_default=None,
               nullable=True)
    safe_drop_index('ix_wm_photos_storage_file_id', 'wm_photos')
    safe_drop_index('ix_wm_photos_storage_provider', 'wm_photos')
    ...
    safe_drop_column('wm_report_configs', 'notes')
    ...
    op.alter_column('work_orders', 'insurance_date_of_loss',
               ...
               existing_nullable=True)
    safe_drop_index('ix_work_orders_insurance_claim_number', 'work_orders')
    safe_drop_index('ix_work_orders_insurance_policy_number', 'work_orders')
    ...
    op.alter_column('xactimate_items', 'updated_at',
               ...
               server_default=None,
               existing_nullable=True)
    safe_drop_index('idx_xactimate_items_description', 'xactimate_items')
    safe_drop_index('idx_xactimate_items_item_code', 'xactimate_items')
    safe_drop_index('idx_xactimate_items_price_date', 'xactimate_items')
    safe_drop_index('idx_xactimate_items_unique_price', 'xactimate_items')
    safe_drop_constraint('uk_xactimate_item_date', 'xactimate_items', 'unique')
    safe_drop_index('idx_xactimate_items_search', 'xactimate_items', postgresql_using='gin')
