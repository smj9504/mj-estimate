...
def upgrade() -> None:
    ...
    op.drop_index('ix_wm_photo_tags_photo', table_name='wm_photo_tags')
    op.drop_index('ix_wm_photo_tags_tag', table_name='wm_photo_tags')
    op.drop_table('wm_photo_tags')

    # Now safe to drop photo_tags
    op.drop_index('ix_photo_tags_client', table_name='photo_tags')
    op.drop_index('ix_photo_tags_id', table_name='photo_tags')
