...
ROOM_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    "bedroom_standard": {
        ...
        "base_items": 100,
        "default_hints": [
            "clothing_hanging", "clothing_folded", "furniture"
        ],
        "mattress": "queen",
    },
    "bedroom_kids": {
        ...
        "base_items": 120,
        "default_hints": [
            "clothing_folded", "toys", "books", "furniture"
        ],
        "mattress": "twin",
    },
    "bedroom_guest": {
    ...
    "kitchen_standard": {
        ...
        "base_items": 90,
        "default_hints": [
            "kitchenware", "appliances_small", "fragile"
        ],
        "mattress": None,
    },
    "kitchen_chef": {
        ...
        "base_items": 150,
        "default_hints": [
            "kitchenware", "appliances_small",
            "appliances_large", "fragile"
        ],
        "mattress": None,
    },
    "kitchen_china": {
        ...
        "base_items": 120,
        "default_hints": [
            "kitchenware", "fragile", "collectibles"
        ],
        "mattress": None,
    },
    ...
    "office_library": {
        ...
        "base_items": 180,
        "default_hints": [
            "books", "collectibles", "furniture", "artwork"
        ],
        "mattress": None,
    },
    "office_tech": {
    ...
    "attic": {
        ...
        "base_items": 100,
        "default_hints": [
            "boxes_stored", "fragile", "collectibles"
        ],
        "mattress": None,
    },
    ...
    "music_room": {
        ...
        "base_items": 60,
        "default_hints": [
            "instruments", "electronics", "furniture"
        ],
        "mattress": None,
    },
